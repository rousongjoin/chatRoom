...
<link rel="stylesheet" type="text/css" href="static/plugins/amaze/css/admin.css"/>
<!-- sidebar start -->
<body>
...
<div class="admin-sidebar am-offcanvas" id="admin-offcanvas">
    <div class="am-offcanvas-bar admin-offcanvas-bar">
        <ul class="am-list admin-sidebar-list">
            <li><a href="${ctx}/UserServlet?method=chatUI"><span class="am-icon-commenting"></span> 聊天</a></li>
            ...
            <li class="admin-parent">
                ...
                <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav">
                    <li><a href="${ctx}/UserServlet?method=configUI&name=${user.name}"><span class="am-icon-group"></span> 个人设置</a></li>
