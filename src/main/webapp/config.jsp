        ...
        <div class="am-tabs am-margin" data-am-tabs>
            ...
            <div class="am-tabs-bd">
                <div class="am-tab-panel am-fade am-in am-active" id="tab1">
                    <form class="am-form am-form-horizontal" id="information-form" action="${pageContext.request.contextPath }/UserServlet?method=updateInformation&name=${user.name}" method="post" data-am-validator>
                ...
                <div class="am-tab-panel am-fade" id="tab3">
                    ...
                    <form class="am-form am-form-horizontal" data-am-validator action="${pageContext.request.contextPath }/UserServlet?method=changePassword&name=${user.name}" method="post">
                        <%session.setAttribute("name", request.getParameter(" ${user.name}")); %>
                        <div class="am-form-group">
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-10">
                                <input type="password" id="password3" name="newpassconfirm" data-equal-to="#password2" required placeholder="请确认新密码...">
                            </div>
                        </div>
